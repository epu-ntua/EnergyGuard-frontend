...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '0.0.0.0', '147.102.6.166'] 
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.header_notifications',
            ],
        },
    },
]
...
# Discarded when using S3-compatible storage for media files instead of local filesystem
MEDIA_URL = '/media/'
