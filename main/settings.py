...
STATIC_ROOT = BASE_DIR / 'staticfiles' # Directory where static files will be collected (for Docker and production)
...
# MinIO (datasets object storage)
OBJECT_STORAGE_ENDPOINT = env("OBJECT_STORAGE_ENDPOINT", default="http://localhost:9000")
OBJECT_STORAGE_ACCESS_KEY = env("OBJECT_STORAGE_ACCESS_KEY", default="")
OBJECT_STORAGE_SECRET_KEY = env("OBJECT_STORAGE_SECRET_KEY", default="")
# MINIO_REGION = env("MINIO_REGION", default="us-east-1")
OBJECT_STORAGE_VERIFY_SSL = env.bool("OBJECT_STORAGE_VERIFY_SSL", default=True)
OBJECT_STORAGE_BUCKET = env("OBJECT_STORAGE_BUCKET", default="datasets")
