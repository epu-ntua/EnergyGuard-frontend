...
function positionCityOverviewPanel() {
  ...
  cityOverviewPanelEl.style.right = Math.round(window.innerWidth - rect.right) + "px";
  cityOverviewPanelEl.style.bottom = Math.round(window.innerHeight - rect.top + 10) + "px";
